...
path  = "../../8.27/stanford-corenlp-4.2.2/"
...
class ProcessData():
    ...
    def get_cooccurrence_matrix(self):
        ...
        with open("../../../comment_opinion_2.0/vocab/cooccurrence_matrix.txt", 'w', encoding='utf-8') as writer:
...
if __name__ == "__main__":
    pd = ProcessData("../data/14res_data_sampled.jsonl")
    pd.read_data()
